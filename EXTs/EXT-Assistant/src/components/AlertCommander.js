    ...
    this.types = [
      {
        ...
        timer: 5000,
        sound: "modules/MMM-GoogleAssistant/resources/warning.ogg"
      },
      {
        event: "error",
        icon: "modules/MMM-GoogleAssistant/resources/error.gif",
        timer: 5000,
        sound: "modules/MMM-GoogleAssistant/resources/error.mp3"
      },
      {
        event: "information",
        icon: "modules/MMM-GoogleAssistant/resources/information.gif",
        timer: 5000,
        sound: null
      },
      {
        event: "success",
        icon: "modules/MMM-GoogleAssistant/resources/success.gif",
        timer: 5000,
        sound: null
      }
    ];
