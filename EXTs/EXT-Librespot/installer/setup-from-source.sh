...
Installer_info "This installer will install librespot v0.8.0 release"
echo
...
rm -rf sources
git clone -b v0.8.0 -c advice.detachedHead=false https://github.com/librespot-org/librespot sources
