...
class screenDisplayer {
  ...
  prepareDom () {
    ...
    if (this.style === "Text" && this.config.counter) {
      ...
      screenCounter.id = "EXT-Screen_TEXT_COUNTER";
      ...
      if (this.style !== "None") {
        ...
        screenStyle.id = "EXT-Screen_STYLE";
  ...
  prepareStyle () {
    ...
    this.bar = new ProgressBar[this.style](document.getElementById("EXT-Screen_STYLE"), {
  ...
  updateDisplay (payload) {
    ...
    if (this.style === "Text") {
      if (this.config.counter) {
        let counter = document.getElementById("EXT-Screen_TEXT_COUNTER");
  ...
  screenShowing () {
    ...
    MM.getModules().enumerate((module) => {
      let speed = 200;
      let options = { lockString: "EXT-Screen_LOCK" };
  ...
  screenHiding () {
    ...
    _logScreen("Hide All modules.");
  }

  /** Hide with Flip animation **/
  hideMe () {
    if (this.hidden()) return _logScreen("Already Hidden.");
    this.hide(1000, () => {}, { lockString: "EXT-Screen_LOCK", animate: "flipOutX" });
  }

  showMe () {
    if (!this.hidden()) return _logScreen("Already Showing.");
    this.show(1000, () => {}, { lockString: "EXT-Screen_LOCK", animate: "flipInX" });
  }
  ...
  checkStyle () {
    ...
    if (found) {
      this.style = found;
      console.log(`[Screen] Display.style: ${this.style}`);
    } else {
      console.error(`[Screen] Display.style Error ! [${this.config.style}]`);
      this.style = "Text";
    }
  }
  ...
  animateModule () {
    let animation = document.getElementById("EXT-Screen");
