...
class sysInfoPage {
  ...
  prepare () {
    ...
    Sysinfo_version_list.id = "WEBSITE-SYSINFO_VERSION_LIST";
    ...
    NPM_Value.id = "WEBSITE-SYSINFO_VERSION-NPM-VALUE";
    NPM_Value.textContent = this.System.VERSION.NPM;
    NPM.appendChild(NPM_Value);

    var OS = document.createElement("div");
    OS.id = "WEBSITE-SYSINFO_VERSION-OS";
    ...
    Kernel_Value.id = "WEBSITE-SYSINFO_VERSION-KERNEL-VALUE";
    ...
    Sysinfo_cpu_list.id = "WEBSITE-SYSINFO_CPU_LIST";
    Sysinfo_cpu_group.appendChild(Sysinfo_cpu_list);

    var Type = document.createElement("div");
    Type.id = "WEBSITE-SYSINFO_CPU-TYPE";
    ...
    Type_Value.id = "WEBSITE-SYSINFO_CPU-TYPE-VALUE";
    Type_Value.textContent = this.System.CPU.type;
    Type.appendChild(Type_Value);

    var Speed = document.createElement("div");
    Speed.id = "WEBSITE-SYSINFO_CPU-SPEED";
    ...
    Usage_Progress.id = "WEBSITE-SYSINFO_CPU-USAGE-PROGRESS";
    ...
    Usage_ProgressBar.id = "WEBSITE-SYSINFO_CPU-USAGE-PROGRESSBAR";
    ...
    Governor.id = "WEBSITE-SYSINFO_CPU-GOVERNOR";
    ...
    Sysinfo_memory_list.id = "WEBSITE-SYSINFO_MEMORY_LIST";
    Sysinfo_memory_group.appendChild(Sysinfo_memory_list);

    var Active = document.createElement("div");
    Active.id = "WEBSITE-SYSINFO_MEMORY-ACTIVE";
    ...
    Active_Progress.id = "WEBSITE-SYSINFO_MEMORY-ACTIVE-PROGRESS";
    ...
    Active_ProgressBar.id = "WEBSITE-SYSINFO_MEMORY-ACTIVE-PROGRESSBAR";
    ...
    Active_ValueTotal.id = "WEBSITE-SYSINFO_MEMORY-ACTIVE-VALUE-TOTAL";
    Active_ValueTotal.textContent = this.System.MEMORY.total;
    Active.appendChild(Active_ValueTotal);

    var Swap = document.createElement("div");
    Swap.id = "WEBSITE-SYSINFO_MEMORY-SWAP";
    ...
    Swap_ValueTotal.id = "WEBSITE-SYSINFO_MEMORY-SWAP-VALUE-TOTAL";
    ...
    Sysinfo_storage_table_used.id = "WEBSITE-SYSINFO_STORAGE_TABLE_USED";
    ...
    Sysinfo_storage_table_percent.id = "WEBSITE-SYSINFO_STORAGE_TABLE_PERCENT";
    ...
    Sysinfo_storage_table_total.id = "WEBSITE-SYSINFO_STORAGE_TABLE_TOTAL";
    ...
    Sysinfo_network_heading_value.id = "WEBSITE-SYSINFO_NETWORK_HEADING_VALUE";
    ...
    Sysinfo_network_list.id = "WEBSITE-SYSINFO_NETWORK_LIST";
    Sysinfo_network_group.appendChild(Sysinfo_network_list);

    var IP = document.createElement("div");
    IP.id = "WEBSITE-SYSINFO_NETWORK-IP";
    ...
    IP_Value.id = "WEBSITE-SYSINFO_NETWORK-IP-VALUE";
    IP_Value.textContent = this.System.NETWORK.ip;
    IP.appendChild(IP_Value);

    var Interface = document.createElement("div");
    Interface.id = "WEBSITE-SYSINFO_NETWORK-INTERFACE";
    ...
    Interface_Value.id = "WEBSITE-SYSINFO_NETWORK-INTERFACE-VALUE";
    Interface_Value.textContent = this.System.NETWORK.name;
    Interface.appendChild(Interface_Value);

    var Information = document.createElement("div");
    Information.id = "WEBSITE-SYSINFO_NETWORK_INFORMATION";
    ...
    networkSpeed.id = "WEBSITE-SYSINFO_NETWORK-SPEED";
    ...
    networkSpeed_Value.id = "WEBSITE-SYSINFO_NETWORK-SPEED-VALUE";
    ...
    Duplex.id = "WEBSITE-SYSINFO_NETWORK-DUPLEX";
    ...
    bitRate_Value.id = "WEBSITE-SYSINFO_NETWORK-RATE-VALUE";
    ...
    frequency.id = "WEBSITE-SYSINFO_NETWORK-FREQUENCY";
    ...
    quality_Value.id = "WEBSITE-SYSINFO_NETWORK-QUALITY-VALUE";
    ...
    Signal.id = "WEBSITE-SYSINFO_NETWORK-SIGNAL";
    ...
    Signal_Value.id = "WEBSITE-SYSINFO_NETWORK-SIGNAL-VALUE";
    ...
    Sysinfo_uptimes_list.id = "WEBSITE-SYSINFO_UPTIMES_LIST";
    Sysinfo_uptimes_group.appendChild(Sysinfo_uptimes_list);

    var Sysinfo_uptime_current = document.createElement("div");
    Sysinfo_uptime_current.id = "WEBSITE-SYSINFO_UPTIMES_CURRENT";
    ...
    Sysinfo_uptime_current_system.id = "WEBSITE-SYSINFO_UPTIMES_CURRENT_SYSTEM";
    ...
    Sysinfo_uptime_current_system_value.id = "WEBSITE-SYSINFO_UPTIMES_CURRENT_SYSTEM_VALUE";
    ...
    Sysinfo_uptime_current_MM.id = "WEBSITE-SYSINFO_UPTIMES_CURRENT_MM";
    ...
    Sysinfo_uptime_current_MM_value.id = "WEBSITE-SYSINFO_UPTIMES_CURRENT_MM_VALUE";
    ...
    Sysinfo_uptime_record.id = "WEBSITE-SYSINFO_UPTIMES_RECORD";
    ...
    Sysinfo_uptime_record_system.id = "WEBSITE-SYSINFO_UPTIMES_RECORD_SYSTEM";
    ...
    Sysinfo_uptime_record_system_value.id = "WEBSITE-SYSINFO_UPTIMES_RECORD_SYSTEM_VALUE";
    ...
    Sysinfo_uptime_record_MM.id = "WEBSITE-SYSINFO_UPTIMES_RECORD_MM";
    ...
    Sysinfo_uptime_record_MM_value.id = "WEBSITE-SYSINFO_UPTIMES_RECORD_MM_VALUE";
    ...
    this.init = true;
    console.log("[WEBSITE] SysInfo Ready !");
  }
  ...
  refreshData () {
    var Hostname_value = document.getElementById("WEBSITE-HOSTNAME_VALUE");
    Hostname_value.textContent = this.System.HOSTNAME;

    /* GPU */
    var GPU_value = document.getElementById("WEBSITE-GPU_VALUE");
    ...
    /* Version */
    var GA_Value = document.getElementById("WEBSITE-SYSINFO_VERSION-GA-VALUE");
    GA_Value.textContent = this.System.VERSION.GA;
    var MM_Value = document.getElementById("WEBSITE-SYSINFO_VERSION-MM-VALUE");
    MM_Value.textContent = this.System.VERSION.MagicMirror;
    ...
    NPM_Value.textContent = this.System.VERSION.NPM;
    var OS_Value = document.getElementById("WEBSITE-SYSINFO_VERSION-OS-VALUE");
    OS_Value.textContent = this.System.VERSION.OS;
    var Kernel_Value = document.getElementById("WEBSITE-SYSINFO_VERSION-KERNEL-VALUE");
    Kernel_Value.textContent = this.System.VERSION.KERNEL;

    /* CPU */
    var Type_Value = document.getElementById("WEBSITE-SYSINFO_CPU-TYPE-VALUE");
    Type_Value.textContent = this.System.CPU.type;
    var Speed_Value = document.getElementById("WEBSITE-SYSINFO_CPU-SPEED-VALUE");
    Speed_Value.textContent = this.System.CPU.speed;
    var Usage_Bar = document.getElementById("WEBSITE-SYSINFO_CPU-USAGE-PROGRESSBAR");
    ...
    var Governor_Value = document.getElementById("WEBSITE-SYSINFO_CPU-GOVERNOR-VALUE");
    Governor_Value.textContent = this.System.CPU.governor;
    var Temp_Bar = document.getElementById("WEBSITE-SYSINFO_CPU-TEMP-PROGRESSBAR");
    ...
    /* MEMORY */
    var Active_ValueTotal = document.getElementById("WEBSITE-SYSINFO_MEMORY-ACTIVE-VALUE-TOTAL");
    Active_ValueTotal.textContent = this.System.MEMORY.total;
    var Active_Bar = document.getElementById("WEBSITE-SYSINFO_MEMORY-ACTIVE-PROGRESSBAR");
    ...
    var Swap_ValueTotal = document.getElementById("WEBSITE-SYSINFO_MEMORY-SWAP-VALUE-TOTAL");
    Swap_ValueTotal.textContent = this.System.MEMORY.swapTotal;
    var Swap_Bar = document.getElementById("WEBSITE-SYSINFO_MEMORY-SWAP-PROGRESSBAR");
    ...
    /* Uptimes*/
    var uptime_current_system = document.getElementById("WEBSITE-SYSINFO_UPTIMES_CURRENT_SYSTEM_VALUE");
    uptime_current_system.textContent = this.System.UPTIME.currentDHM;
    var uptime_current_MM = document.getElementById("WEBSITE-SYSINFO_UPTIMES_CURRENT_MM_VALUE");
    uptime_current_MM.textContent = this.System.UPTIME.MMDHM;
    var uptime_record_system = document.getElementById("WEBSITE-SYSINFO_UPTIMES_RECORD_SYSTEM_VALUE");
    uptime_record_system.textContent = this.System.UPTIME.recordCurrentDHM;
    var uptime_record_MM = document.getElementById("WEBSITE-SYSINFO_UPTIMES_RECORD_MM_VALUE");
    uptime_record_MM.textContent = this.System.UPTIME.recordMMDHM;

    /* NETWORK */
    var information = document.getElementById("WEBSITE-SYSINFO_NETWORK_INFORMATION");
    var IP = document.getElementById("WEBSITE-SYSINFO_NETWORK-IP-VALUE");
    IP.textContent = this.System.NETWORK.ip;
    var Interface = document.getElementById("WEBSITE-SYSINFO_NETWORK-INTERFACE-VALUE");
    Interface.textContent = this.System.NETWORK.name;
    var Speed_ = document.getElementById("WEBSITE-SYSINFO_NETWORK-SPEED");
    var Speed = document.getElementById("WEBSITE-SYSINFO_NETWORK-SPEED-VALUE");
    Speed.textContent = `${this.System.NETWORK.speed} Mbit/s`;
    var Duplex_ = document.getElementById("WEBSITE-SYSINFO_NETWORK-DUPLEX");
    var Duplex = document.getElementById("WEBSITE-SYSINFO_NETWORK-DUPLEX-VALUE");
    Duplex.textContent = this.System.NETWORK.duplex;
    // wireless
    var SSID_ = document.getElementById("WEBSITE-SYSINFO_NETWORK-SSID");
    var SSID = document.getElementById("WEBSITE-SYSINFO_NETWORK-SSID-VALUE");
    ...
    var quality_ = document.getElementById("WEBSITE-SYSINFO_NETWORK-QUALITY");
    var quality = document.getElementById("WEBSITE-SYSINFO_NETWORK-QUALITY-VALUE");
    quality.textContent = this.System.NETWORK.quality;
    var Signal_ = document.getElementById("WEBSITE-SYSINFO_NETWORK-SIGNAL");
    var Signal = document.getElementById("WEBSITE-SYSINFO_NETWORK-SIGNAL-VALUE");
    Signal.textContent = `${this.System.NETWORK.signalLevel} dBm`;
    var bar = document.getElementById("WEBSITE-SYSINFO_NETWORK_BAR");
    ...
    // storage
    var Sysinfo_storage_table = document.getElementById("WEBSITE-SYSINFO_STORAGE_TABLE");
    this.System.STORAGE.forEach((partition, id) => {
      for (let [name, values] of Object.entries(partition)) {
        ...
        Sysinfo_storage_mount.id = "WEBSITE-SYSINFO_STORAGE-MOUNT";
        ...
        Sysinfo_storage_mount_used.id = "WEBSITE-SYSINFO_STORAGE-USED";
        ...
        Sysinfo_storage_mount_ProgressField.id = "WEBSITE-SYSINFO_STORAGE-PROGRESS-FIELD";
        ...
        Sysinfo_storage_mount_Progress.id = "WEBSITE-SYSINFO_STORAGE-PROGRESS";
        ...
        Sysinfo_storage_mount_ProgressBar.id = "WEBSITE-SYSINFO_STORAGE-PROGRESSBAR";
        ...
        Sysinfo_storage_mount_size.id = "WEBSITE-SYSINFO_STORAGE-SIZE";
