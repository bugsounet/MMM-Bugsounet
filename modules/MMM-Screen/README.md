...
![screenshot1](https://raw.githubusercontent.com/bugsounet/MMM-Screen/dev/screenshot/screenshot.png)

![screenshot2](https://raw.githubusercontent.com/bugsounet/MMM-Screen/dev/screenshot/screenshot2.png)

![screenshot3](https://raw.githubusercontent.com/bugsounet/MMM-Screen/dev/screenshot/screenshot3.png)

![screenshot4](https://raw.githubusercontent.com/bugsounet/MMM-Screen/dev/screenshot/screenshot4.png)
...
git clone https://github.com/bugsounet/MMM-Screen
cd MMM-Screen
npm run setup
```

`MMM-Screen` is now available for Windows environment!
...
* You can install it by using this command in your `MMM-Screen` folder: `npm run pinctrl`
...
⚠ **Pir Sensor is not available under windows environement**
 ...
 | Option  | Description | Type | Default |
 | ------- | --- | --- | --- |
 | animate | Animate MMM-Screen module on detect | Boolean | true |
...
* Available mode:
  ...
  * `mode: 1` - Wake up / turn OFF automaticaly by CRON and use countdown
    * `MMM-Screen` timer will be used before turn off screen
  ...
  * `mode: 2` - Your screen will be fully managed by cron
    * `MMM-Screen` timer will be not displayed and not used
...
* Available mode:
  ...
  * `touchMode: 2`
    * One Click on the MMM-Screen area will restart the timer
    * Long Click on the screen will shutdown or wake up the screen (toogle)
  * `touchMode: 3`
    * One Click on the MMM-Screen area will restart the timer
    * Doucle Click on the MMM-Screen area will shutdown the screen
...
```sh
cd ~/MagicMirror/modules/MMM-Bugsounet/modules/MMM-Screen
npm run rebuild
```
