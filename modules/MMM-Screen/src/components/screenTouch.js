...
class screenTouch {
  constructor (Touch, Tools) {
    ...
    this.clickCount = 0;
    console.log("[MMM-Screen] screenTouch Ready");
  }

  touch () {
    let TouchScreen = document.getElementById("MMM-Screen");
    ...
    if (!this.mode) console.log("[MMM-Screen] Touch Screen Function disabled.");
    else console.log(`[MMM-Screen] Touch Screen Function added. [mode ${this.mode}]`);
  }
}
