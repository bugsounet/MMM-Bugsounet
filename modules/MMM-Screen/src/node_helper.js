...
module.exports = NodeHelper.create({
  ...
  stop () {
    this.stopped = true;
    console.log("Stopping module helper: MMM-Screen...");
    console.log("[MMM-Screen] Stopping Governor");
    this.governor.working();
    console.log("[MMM-Screen] Stopping Screen");
    this.screen.close();
    console.log("[MMM-Screen] Stopping Pir");
    this.pir.stop();
  },
  ...
  async parse () {
    if (this.config.debug) log = (...args) => { console.log("[MMM-Screen]", ...args); };
    console.log("[MMM-Screen] Version:", require("./package.json").version, "rev:", require("./package.json").rev);
    ...
    if (!this.screen) {
      ...
      console.log("[MMM-Screen] Started!");
    } else {
      console.log("[MMM-Screen] Already Started!");
    }
