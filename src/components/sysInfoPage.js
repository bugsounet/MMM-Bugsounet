...
class sysInfoPage {
  constructor (Tools) {
    ...
    console.log("[Bugsounet] SysInfo Loaded !");
  }

  prepare () {
    var wrapper = document.createElement("div");
    wrapper.id = "BUGSOUNET_SYSINFO";
    wrapper.classList.add("hidden");

    var content_wrapper = document.createElement("div");
    content_wrapper.id = "BUGSOUNET-CONTENT_WRAPPER";
    wrapper.appendChild(content_wrapper);

    var Hostname_container = document.createElement("div");
    Hostname_container.id = "BUGSOUNET-HOSTNAME_CONTAINER";
    ...
    Sysinfo_version_list.id = "BUGSOUNET-SYSINFO_VERSION_LIST";
    Sysinfo_version_group.appendChild(Sysinfo_version_list);

    var BugsounetVersion = document.createElement("div");
    BugsounetVersion.id = "BUGSOUNET-SYSINFO_VERSION-BUGSOUNET";
    BugsounetVersion.textContent = "MMM-Bugsounet:";
    Sysinfo_version_list.appendChild(BugsounetVersion);
    var BugsounetVersion_Value = document.createElement("div");
    BugsounetVersion_Value.id = "BUGSOUNET-SYSINFO_VERSION-BUGSOUNET-VALUE";
    BugsounetVersion_Value.textContent = this.System.VERSION.Bugsounet;
    BugsounetVersion.appendChild(BugsounetVersion_Value);

    var MM = document.createElement("div");
    MM.id = "BUGSOUNET-SYSINFO_VERSION-MM";
    MM.textContent = "MagicMirror²:";
    Sysinfo_version_list.appendChild(MM);
    var MM_Value = document.createElement("div");
    MM_Value.id = "BUGSOUNET-SYSINFO_VERSION-MM-VALUE";
    MM_Value.textContent = this.System.VERSION.MagicMirror;
    MM.appendChild(MM_Value);

    var ELECTRON = document.createElement("div");
    ELECTRON.id = "BUGSOUNET-SYSINFO_VERSION-ELECTRON";
    ELECTRON.textContent = "Electron:";
    Sysinfo_version_list.appendChild(ELECTRON);
    var ELECTRON_Value = document.createElement("div");
    ELECTRON_Value.id = "BUGSOUNET-SYSINFO_VERSION-ELECTRON-VALUE";
    ...
    Sysinfo_cpu_list.id = "BUGSOUNET-SYSINFO_CPU_LIST";
    ...
    Usage_ProgressBar.id = "BUGSOUNET-SYSINFO_CPU-USAGE-PROGRESSBAR";
    ...
    Temp_ProgressBar.id = "BUGSOUNET-SYSINFO_CPU-TEMP-PROGRESSBAR";
    ...
    Sysinfo_memory_list.id = "BUGSOUNET-SYSINFO_MEMORY_LIST";
    ...
    Active_Progress.id = "BUGSOUNET-SYSINFO_MEMORY-ACTIVE-PROGRESS";
    ...
    Active_ProgressBar.id = "BUGSOUNET-SYSINFO_MEMORY-ACTIVE-PROGRESSBAR";
    ...
    Active_ValueTotal.id = "BUGSOUNET-SYSINFO_MEMORY-ACTIVE-VALUE-TOTAL";
    ...
    Swap_ValueTotal.id = "BUGSOUNET-SYSINFO_MEMORY-SWAP-VALUE-TOTAL";
    ...
    Sysinfo_network_list.id = "BUGSOUNET-SYSINFO_NETWORK_LIST";
    ...
    Sysinfo_uptimes_list.id = "BUGSOUNET-SYSINFO_UPTIMES_LIST";
    ...
    Sysinfo_uptime_current_MM.id = "BUGSOUNET-SYSINFO_UPTIMES_CURRENT_MM";
    ...
    Sysinfo_uptime_record_MM.id = "BUGSOUNET-SYSINFO_UPTIMES_RECORD_MM";
    ...
    this.init = true;
    console.log("[Bugsounet] SysInfo Ready !");
  }
  ...
  show () {
    if (!this.showing && this.init) {
      ...
      MM.getModules().enumerate((module) => {
        module.hide(500, () => {}, { lockString: "BUGSOUNET_SYSINFO_LOCK" });
      });
      console.log("[Bugsounet] Show SysInfo");
      var SysInfo = document.getElementById("BUGSOUNET_SYSINFO");
      SysInfo.classList.remove("hidden");
      removeAnimateCSS("BUGSOUNET_SYSINFO", "backOutRight");
      addAnimateCSS("BUGSOUNET_SYSINFO", "backInLeft", 1);
      this.showing = true;
      this.sendNotification("Bugsounet_BUGSOUNET-CONNECTED");
    }
  }
  ...
  hide () {
    if (this.showing && this.init) {
      clearInterval(this.timerRefresh);
      clearTimeout(this.timerHide);
      console.log("[Bugsounet] Hide SysInfo");
      var SysInfo = document.getElementById("BUGSOUNET_SYSINFO");
      removeAnimateCSS("BUGSOUNET_SYSINFO", "backInLeft");
      addAnimateCSS("BUGSOUNET_SYSINFO", "backOutRight", 1);
      this.timerHide = setTimeout(() => {
        SysInfo.classList.add("hidden");
        this.showing = false;
        MM.getModules().enumerate((module) => {
          module.show(500, () => {}, { lockString: "BUGSOUNET_SYSINFO_LOCK" });
        });
        this.sendNotification("Bugsounet_BUGSOUNET-DISCONNECTED");
      }, 1000);
    }
  }
  ...
  refreshData () {
    var Hostname_value = document.getElementById("BUGSOUNET-HOSTNAME_VALUE");
    ...
    /* Version */
    var BUGSOUNET_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-BUGSOUNET-VALUE");
    BUGSOUNET_Value.textContent = this.System.VERSION.Bugsounet;
    var MM_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-MM-VALUE");
    MM_Value.textContent = this.System.VERSION.MagicMirror;
    var ELECTRON_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-ELECTRON-VALUE");
    ELECTRON_Value.textContent = this.System.VERSION.ELECTRON;
    var Node_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-NODE-VALUE");
    Node_Value.textContent = this.System.VERSION.NODECORE;
    var NPM_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-NPM-VALUE");
    NPM_Value.textContent = this.System.VERSION.NPM;
    var OS_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-OS-VALUE");
    OS_Value.textContent = this.System.VERSION.OS;
    var Kernel_Value = document.getElementById("BUGSOUNET-SYSINFO_VERSION-KERNEL-VALUE");
    Kernel_Value.textContent = this.System.VERSION.KERNEL;

    /* CPU */
    var Type_Value = document.getElementById("BUGSOUNET-SYSINFO_CPU-TYPE-VALUE");
    Type_Value.textContent = this.System.CPU.type;
    var Speed_Value = document.getElementById("BUGSOUNET-SYSINFO_CPU-SPEED-VALUE");
    Speed_Value.textContent = this.System.CPU.speed;
    var Usage_Bar = document.getElementById("BUGSOUNET-SYSINFO_CPU-USAGE-PROGRESSBAR");
    ...
    var Governor_Value = document.getElementById("BUGSOUNET-SYSINFO_CPU-GOVERNOR-VALUE");
    Governor_Value.textContent = this.System.CPU.governor;
    var Temp_Bar = document.getElementById("BUGSOUNET-SYSINFO_CPU-TEMP-PROGRESSBAR");
    ...
    /* MEMORY */
    var Active_ValueTotal = document.getElementById("BUGSOUNET-SYSINFO_MEMORY-ACTIVE-VALUE-TOTAL");
    Active_ValueTotal.textContent = this.System.MEMORY.total;
    var Active_Bar = document.getElementById("BUGSOUNET-SYSINFO_MEMORY-ACTIVE-PROGRESSBAR");
    ...
    var Swap_ValueTotal = document.getElementById("BUGSOUNET-SYSINFO_MEMORY-SWAP-VALUE-TOTAL");
    Swap_ValueTotal.textContent = this.System.MEMORY.swapTotal;
    var Swap_Bar = document.getElementById("BUGSOUNET-SYSINFO_MEMORY-SWAP-PROGRESSBAR");
    ...
    var IP = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-IP-VALUE");
    IP.textContent = this.System.NETWORK.ip;
    var Interface = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-INTERFACE-VALUE");
    Interface.textContent = this.System.NETWORK.name;
    var Speed_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SPEED");
    var Speed = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SPEED-VALUE");
    Speed.textContent = `${this.System.NETWORK.speed} Mbit/s`;
    var Duplex_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-DUPLEX");
    var Duplex = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-DUPLEX-VALUE");
    Duplex.textContent = this.System.NETWORK.duplex;
    // wireless
    var SSID_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SSID");
    var SSID = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SSID-VALUE");
    SSID.textContent = this.System.NETWORK.ssid;
    var bitRate_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-RATE");
    var bitRate = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-RATE-VALUE");
    bitRate.textContent = `${this.System.NETWORK.rate}`;
    var frequency_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-FREQUENCY");
    var frequency = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-FREQUENCY-VALUE");
    frequency.textContent = `${this.System.NETWORK.frequency} GHz`;
    var quality_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-QUALITY");
    var quality = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-QUALITY-VALUE");
    quality.textContent = this.System.NETWORK.quality;
    var Signal_ = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SIGNAL");
    var Signal = document.getElementById("BUGSOUNET-SYSINFO_NETWORK-SIGNAL-VALUE");
    Signal.textContent = `${this.System.NETWORK.signalLevel} dBm`;
    var bar = document.getElementById("BUGSOUNET-SYSINFO_NETWORK_BAR");
    ...
    // storage
    var Sysinfo_storage_table = document.getElementById("BUGSOUNET-SYSINFO_STORAGE_TABLE");
    this.System.STORAGE.forEach((partition, id) => {
      for (let [name, values] of Object.entries(partition)) {
        var check_mount = document.getElementById(`BUGSOUNET-SYSINFO_STORAGE-MOUNTVALUES${id}`);
        if (check_mount) {
          // update
        ...
        Sysinfo_storage_mountValues.id = `BUGSOUNET-SYSINFO_STORAGE-MOUNTVALUES${id}`;
        Sysinfo_storage_table.appendChild(Sysinfo_storage_mountValues);

        var Sysinfo_storage_mount = document.createElement("td");
        Sysinfo_storage_mount.id = "BUGSOUNET-SYSINFO_STORAGE-MOUNT";
        ...
        Sysinfo_storage_mount_used.id = "BUGSOUNET-SYSINFO_STORAGE-USED";
        ...
        Sysinfo_storage_mount_ProgressField.id = "BUGSOUNET-SYSINFO_STORAGE-PROGRESS-FIELD";
        ...
        Sysinfo_storage_mount_Progress.id = "BUGSOUNET-SYSINFO_STORAGE-PROGRESS";
        ...
        Sysinfo_storage_mount_ProgressBar.id = "BUGSOUNET-SYSINFO_STORAGE-PROGRESSBAR";
        ...
        Sysinfo_storage_mount_size.id = "BUGSOUNET-SYSINFO_STORAGE-SIZE";
